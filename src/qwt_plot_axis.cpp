...
struct QwtPlot::AxisShareData
{
    AxisShareData(): isMajorLabelsVisible(true),
                     isMinorLabelsVisible(false),
                     isPlusSignVisible(false),
                     isMinusSignVisible(false),
                     decimalWidth(0)
    {
    ...
    bool isMajorLabelsVisible : 1;
    bool isMinorLabelsVisible  : 1;
    bool isPlusSignVisible : 1;
    bool isMinusSignVisible : 1;
...
{
    d_axisShareData = new AxisShareData();
...
void QwtPlot::setAxisTickColor(const QColor& clr)
{
    d_axisShareData->tickColor = clr;
    updateAxes();
}

QColor QwtPlot::axisTickColor() const
{
    return d_axisShareData->tickColor;
}

void QwtPlot::setAxisLabelColor(const QColor& clr)
{
    d_axisShareData->labelColor = clr;
    updateAxes();
}

QColor QwtPlot::axisLabelColor() const
{
   return d_axisShareData->labelColor;
}

void QwtPlot::setAxisLabelFont(const QFont& f)
{
    d_axisShareData->labelFont = f;
    updateAxes();
}

QFont QwtPlot::axisLabelFont() const
{
    return d_axisShareData->labelFont;
}

void QwtPlot::setAxisTickWidth(int width)
{
    d_axisShareData->penWidth = width;
    updateAxes();
}

int QwtPlot::axisTickWidth() const
{
    return d_axisShareData->penWidth;
}

void QwtPlot::setMajorLabelsVisible(bool visible)
{
    d_axisShareData->isMajorLabelsVisible = visible;
    updateAxes();
}

bool QwtPlot::isMajorLabelsVisible() const
{
    return d_axisShareData->isMajorLabelsVisible;
}

void QwtPlot::setMinorLabelsVisible(bool visible)
{
    d_axisShareData->isMinorLabelsVisible = visible;
    updateAxes();
}

bool QwtPlot::isMinorLabelsVisible() const
{
    return d_axisShareData->isMinorLabelsVisible;
}

void QwtPlot::setPlusSignVisible(bool visible)
{
    d_axisShareData->isPlusSignVisible = visible;
    updateAxes();
}

bool QwtPlot::isPlusSignVisible() const
{
    return d_axisShareData->isPlusSignVisible;
}

void QwtPlot::setMinusSignVisible(bool visible)
{
    d_axisShareData->isMinusSignVisible = visible;
    updateAxes();
}

bool QwtPlot::isMinusSignVisible() const
{
    return d_axisShareData->isMinusSignVisible;
}

void QwtPlot::setPrefix(const QString& prefix)
{
    d_axisShareData->prefix = prefix;
    updateAxes();
}

QString QwtPlot::prefix() const
{
    return d_axisShareData->prefix;
}

void QwtPlot::setSuffix(const QString& suffix)
{
    d_axisShareData->suffix = suffix;
    updateAxes();
}

QString QwtPlot::suffix() const
{
    return d_axisShareData->suffix;
}

void QwtPlot::setDecimalWidth(int width)
{
    d_axisShareData->decimalWidth = width;
}

int QwtPlot::decimalWidth() const
{
    return d_axisShareData->decimalWidth;
}
...
void QwtPlot::updateAxes()
{
    ...
    for ( int axisId = 0; axisId < axisCnt; axisId++ )
    {
        ...
        scaleWidget->setTickWidth(d_axisShareData->penWidth);
        scaleWidget->setLabelFont(d_axisShareData->labelFont);
        scaleWidget->setTickColor(d_axisShareData->tickColor);
        scaleWidget->setLabelColor(d_axisShareData->labelColor);
        scaleWidget->setMajorLabelsVisible(d_axisShareData->isMajorLabelsVisible);
        scaleWidget->setMinorLabelsVisible(d_axisShareData->isMinorLabelsVisible);
        scaleWidget->setPlusSignVisible(d_axisShareData->isPlusSignVisible);
        scaleWidget->setMinusSignVisible(d_axisShareData->isMinusSignVisible);
        scaleWidget->setPrefix(d_axisShareData->prefix);
        scaleWidget->setSuffix(d_axisShareData->suffix);
        scaleWidget->setDecimalWidth(d_axisShareData->decimalWidth);
