...
public:
    ...
    float barChartOpacity = 1.0;
    int barChartLineWidth = 1;
    Qt::BrushStyle barChartFillStyle = Qt::SolidPattern;
    QwtColumnSymbol::FrameStyle barChartFrameStyle;
    QPen barChartBorderPen = Qt::NoPen;
...
void QwtPlot::setTitleVisible(bool visible)
{
    d_data->titleVisible = visible;
    updateLayout();
}

bool QwtPlot::isTitleVisible() const
{
...
void QwtPlot::setLineWidth(int width)
{
    d_data->lineWidth = width;
}

int QwtPlot::lineWidth() const
{
    return d_data->lineWidth;
}

void QwtPlot::setLineOpacity(float opacity)
{
    d_data->lineOpacity = opacity;
}

float QwtPlot::lineOpacity() const
{
    return d_data->lineOpacity;
}
...
//    // resize and show the visible widgets
    ...
    if ( !d_data->titleLabel->text().isEmpty() && d_data->titleVisible)
    {
...
void QwtPlot::setBarChartOpacity(float opacity)
{
    d_data->barChartOpacity = opacity;
//    replot();
}

float QwtPlot::barChartOpacity() const
{
    return d_data->barChartOpacity;
}

void QwtPlot::setBarChartFillStyle(Qt::BrushStyle bs)
{
    d_data->barChartFillStyle = bs;
//    replot();
}

Qt::BrushStyle QwtPlot::barChartFillStyle() const
{
    return d_data->barChartFillStyle;
}

void QwtPlot::setBarChartBorderPen(const QPen& pen)
{
    d_data->barChartBorderPen = pen;
//    replot();
}

QPen QwtPlot::barChartBorderPen() const
{
    return d_data->barChartBorderPen;
}

void QwtPlot::setBarChartLineWidth(int width)
{
    d_data->barChartLineWidth = width;
//    replot();
}

int QwtPlot::barChartLineWidth() const
{
    return d_data->barChartLineWidth;
}

void QwtPlot::setBarChartStyle(QwtColumnSymbol::FrameStyle fs)
{
    d_data->barChartFrameStyle = fs;
//    replot();
}

QwtColumnSymbol::FrameStyle QwtPlot::barChartStyle() const
{
    return d_data->barChartFrameStyle;
}
