...
public:
    PrivateData():
        ...
        penWidth( 0 ),
        minExtent( 0.0 ),
        isMajorLabelsVisible( true ),
        isMinorLabelsVisible( true),
...
void QwtAbstractScaleDraw::setTickColor(const QColor& clr)
{
    d_data->tickColor = clr;
}

QColor QwtAbstractScaleDraw::tickColor() const
{
    return d_data->tickColor;
}

void QwtAbstractScaleDraw::setLabelColor(const QColor& clr)
{
    d_data->labelColor = clr;
}

QColor QwtAbstractScaleDraw::labelColor() const
{
    return d_data->labelColor;
}

void QwtAbstractScaleDraw::setMajorLabelsVisible(bool visible)
{
    d_data->isMajorLabelsVisible = visible;
}

bool QwtAbstractScaleDraw::isMajorLabelsVisible() const
{
    return d_data->isMajorLabelsVisible;
}

void QwtAbstractScaleDraw::setMinorLabelsVisible(bool visible)
{
    d_data->isMinorLabelsVisible = visible;
}

bool QwtAbstractScaleDraw::isMinorLabelsVisible() const
{
    return d_data->isMinorLabelsVisible;
}

void QwtAbstractScaleDraw::setPlusSignVisible(bool visible)
{
    d_data->isPlusSignVisible = visible;
}

bool QwtAbstractScaleDraw::isPlusSignVisible() const
{
    return d_data->isPlusSignVisible;
}

void QwtAbstractScaleDraw::setMinusSignVisible(bool visible)
{
    d_data->isMinusSignVisible = visible;
}

bool QwtAbstractScaleDraw::isMinusSignVisible() const
{
    return d_data->isMinusSignVisible;
}

void QwtAbstractScaleDraw::setPrefix(const QString& prefix)
{
    d_data->prefix = prefix;
}

QString QwtAbstractScaleDraw::prefix() const
{
    return d_data->prefix;
}

void QwtAbstractScaleDraw::setSuffix(const QString& suffix)
{
    d_data->suffix = suffix;
}

QString QwtAbstractScaleDraw::suffix() const
{
    return d_data->suffix;
}

void QwtAbstractScaleDraw::setDecimalWidth(int width)
{
    d_data->decimalWidth = width;
}

int QwtAbstractScaleDraw::decimalWidth() const
{
    return d_data->decimalWidth;
}
...
void QwtAbstractScaleDraw::setLabelFont(const QFont& f)
{
    d_data->labelFont = f;
}

QFont QwtAbstractScaleDraw::labelFont() const
{
    ...
    const QPalette& palette ) const
{
    ...
    {
        painter->save();
        painter->setPen( d_data->labelColor ); // ignore pen style
        painter->setFont( d_data->labelFont );

        // draw major labels
        if (d_data->isMajorLabelsVisible) {
        ...
        // draw minor labels
        if (d_data->isMinorLabelsVisible) {

            const QList<double> & minorTicks =
                    d_data->scaleDiv.ticks(QwtScaleDiv::MinorTick);
