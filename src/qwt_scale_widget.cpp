...
public:
    PrivateData():
        scaleDraw( NULL ), visible(true), titleVisible(true)
    {
...
void QwtScaleWidget::setTitleVisible(bool visible)
{
    d_data->titleVisible = visible;
    layoutScale();
}

bool QwtScaleWidget::isTitleVisible() const
{
    return d_data->titleVisible;
}

void QwtScaleWidget::setShown(bool visible)
{
    d_data->visible = visible;
    // the point which incur infinite calls
    layoutScale();
}

bool QwtScaleWidget::isShown() const
{
    return d_data->visible;
}

void QwtScaleWidget::setLabelColor(const QColor& clr)
{
    d_data->scaleDraw->setLabelColor(clr);
}

QColor QwtScaleWidget::labelColor() const
{
    return d_data->scaleDraw->labelColor();
}

void QwtScaleWidget::setTickColor(const QColor& clr)
{
    d_data->scaleDraw->setTickColor(clr);
}

QColor QwtScaleWidget::tickColor() const
{
    return d_data->scaleDraw->tickColor();
}

void QwtScaleWidget::setTickWidth(int width)
{
    d_data->scaleDraw->setPenWidth(width);
}

int QwtScaleWidget::tickWidth() const
{
    return d_data->scaleDraw->penWidth();
}

void QwtScaleWidget::setLabelFont(const QFont& f)
{
    d_data->scaleDraw->setLabelFont(f);
}

QFont QwtScaleWidget::labelFont() const
{
    return d_data->scaleDraw->labelFont();
}

void QwtScaleWidget::setMajorLabelsVisible(bool visible)
{
    d_data->scaleDraw->setMajorLabelsVisible(visible);
}

bool QwtScaleWidget::isMajorLabelsVisible() const
{
    return d_data->scaleDraw->isMajorLabelsVisible();
}

void QwtScaleWidget::setMinorLabelsVisible(bool visible)
{
    d_data->scaleDraw->setMinorLabelsVisible(visible);
}

bool QwtScaleWidget::isMinorLabelsVisible() const
{
    return d_data->scaleDraw->isMinorLabelsVisible();
}

void QwtScaleWidget::setPlusSignVisible(bool visible)
{
    d_data->scaleDraw->setPlusSignVisible(visible);
}

bool QwtScaleWidget::isPlusSignVisible() const
{
    return d_data->scaleDraw->isPlusSignVisible();
}

void QwtScaleWidget::setMinusSignVisible(bool visible)
{
    d_data->scaleDraw->setMinusSignVisible(visible);
}

bool QwtScaleWidget::isMinusSignVisible() const
{
    return d_data->scaleDraw->isMinusSignVisible();
}

void QwtScaleWidget::setPrefix(const QString& prefix)
{
    d_data->scaleDraw->setPrefix(prefix);
}

QString QwtScaleWidget::prefix() const
{
    return d_data->scaleDraw->prefix();
}

void QwtScaleWidget::setSuffix(const QString& suffix)
{
    d_data->scaleDraw->setSuffix(suffix);\
}

QString QwtScaleWidget::suffix() const
{
    return d_data->scaleDraw->suffix();
}

void QwtScaleWidget::setDecimalWidth(int width)
{
    d_data->scaleDraw->setDecimalWidth(width);
}

int QwtScaleWidget::decimalWidth() const
{
    return d_data->scaleDraw->decimalWidth();
}
...
void QwtScaleWidget::draw( QPainter *painter ) const
{
    ...
    if ( !d_data->title.isEmpty() && d_data->titleVisible)
