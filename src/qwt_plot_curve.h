...
public:
    ...
    */
    ...
    void setLabelOffsetX(int offset);
    int labelOffsetX() const;

    void setLabelOffsetY(int offset);
...
protected:
    ...
    void drawDropLines(QPainter* painter, const QPolygonF& ploygon, const QRectF& canvas) const;
    void drawLabels(QPainter *painter, const QwtSymbol &,
                    const QwtScaleMap &xMap, const QwtScaleMap &yMap,
                    const QRectF &canvasRect, int from, int to ) const;
    void drawLabels_(QPainter* painter, const QPolygonF& points, const QwtSeriesData<QPointF>& data) const;
