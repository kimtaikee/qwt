...
public:
    ...
    void setAxisTickColor(const QColor& clr);
    QColor axisTickColor() const;

    void setAxisLabelColor(const QColor& clr);
    QColor axisLabelColor() const;

    void setAxisLabelFont(const QFont& f);
    QFont axisLabelFont() const;

    void setAxisTickWidth(int width);
    int axisTickWidth() const;
    ...
    void setBarChartOpacity(float opacity);
    float barChartOpacity() const;

    void setBarChartFillStyle(Qt::BrushStyle bs);
    Qt::BrushStyle barChartFillStyle() const;

    void setBarChartBorderPen(const QPen& pen);
    QPen barChartBorderPen() const;

    void setBarChartLineWidth(int width);
    int barChartLineWidth() const;

    void setBarChartStyle(QwtColumnSymbol::FrameStyle fs);
    QwtColumnSymbol::FrameStyle barChartStyle() const;
